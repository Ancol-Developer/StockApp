...
namespace StockMarketSolution.ViewComponents
{
 public class SelectedStockViewComponent : ViewComponent
 {
  ...
  public SelectedStockViewComponent(IOptions<TradingOption> tradingOptions, IStockService stocksService, IFinnhubService finnhubService, IConfiguration configuration)
  {
